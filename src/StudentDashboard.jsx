...
// 2. Cronómetro Aislado con Barra de Progreso Visual
...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    const requestWakeLock = async () => {
      ...
      } catch (err) { console.log('Wake Lock API no soportada o bloqueada.'); }
    };
    requestWakeLock();
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-16 relative">
      ...
      <header className="bg-slate-900 border-b border-slate-800 p-4 sticky top-0 z-30 flex justify-between items-center shadow-md">
        <div>
          <h1 className="text-xl font-extrabold text-amber-500 tracking-tight">GYM CLASSROOM</h1>
      ...
      <main className="max-w-md mx-auto p-4 mt-2 mb-10">
        {loading ? (
          ...
          <div className="space-y-4">
            <h2 className="text-slate-300 font-bold mb-4 px-1">Tus Rutinas</h2>
